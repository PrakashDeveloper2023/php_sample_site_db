...
<body>
                ...
                <?php if(isset($_SESSION['message']['success'])): ?>
                    <div class="mb-3 alert alert-success rounded-0">
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="#" class="text-reset text-decoration-none" onclick="$(this).closest('.alert').remove()"><i class="fa fa-times"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
    ...
    <div class="modal fade rounded-0" id="FormModal" tabindex="-1" data-bs-backdrop='static' data-bs-keyboard="false">
        <div class="modal-dialog modal-xl modal-fullscreen-lg-down modal-dialog-centered modal-dialog-scrollable rounded-0">
